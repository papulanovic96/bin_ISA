...
export class RentaCarServiceService {
  ...
  private fastReservation: string;
  constructor(private http: HttpClient) {
    this.fastReservation = 'http://localhost:4200/Car/getDiscount';
  ...
  getForFastReservation(): Observable<CarDiscount[]> {
    ...
    return this.http.get<CarDiscount[]>(this.fastReservation , httpOptions);
  }
